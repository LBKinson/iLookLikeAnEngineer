...
(r?' target="_blank">':">")+'<img src="https://g.twimg.com/dev/documentation/image/reply_hover.png"></a><a href="https://twitter.com/intent/retweet?tweet_id='+m[b]+'" class="twitter_retweet_icon"'+(r?' target="_blank">':">")+'<img src="https://g.twimg.com/dev/documentation/image/retweet_on.png"></a><a href="https://twitter.com/intent/favorite?tweet_id='+m[b]+'" class="twitter_fav_icon"'+(r?' target="_blank">':">")+"<img src='https://g.twimg.com/dev/documentation/image/favorite_on.png'></a></p>");F&&void 0!==h[b]&&(l=h[b],void 0!==l?(l=l.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0],l=decodeURIComponent(l).split('"')[1]):l=void 0,d+='<div class="media"><img src="'+l+'" alt="Image from tweet" /></div>');
