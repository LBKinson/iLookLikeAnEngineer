      ...
      while(n < x) {
        ...
        if (showInteractionLinks) {
          op += '<p class="interact"><a href="https://twitter.com/intent/' +
              ...
              '<img src="https://g.twimg.com/dev/documentation/image/reply_hover.png"></a><a href="https://twitter.com/intent/retweet?tweet_id=' +
              tids[n] + '" class="twitter_retweet_icon"' +
              (targetBlank ? ' target="_blank">' : '>') + '<img src="https://g.twimg.com/dev/documentation/image/retweet_on.png"></a>' +
              '<a href="https://twitter.com/intent/favorite?tweet_id=' +
              tids[n] + '" class="twitter_fav_icon"' +
              (targetBlank ? ' target="_blank">' : '>') + '<img src="https://g.twimg.com/dev/documentation/image/favorite_on.png"></a></p>';
        }
